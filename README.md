...
The Paletted_Plus vesion adds a 4th page of color choices (subtle variations of white) along with a few additional variable that should make it easier to add additional color pages without having to change stuff elsewhere in the code.   Configure this in the "User Variables" section near the top after the libraries.
