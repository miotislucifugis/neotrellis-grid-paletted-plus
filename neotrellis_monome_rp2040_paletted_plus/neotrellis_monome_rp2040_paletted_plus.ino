...
const uint8_t allpalettes[colorNum + 1][3][16] = {
  ...
  { //orange white
    ...
    { 0, 10, 0, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200 } },
  { //teal white
    { 0, 5, 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200 },
    { 0, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 } },
  { //warmer white
    { 20, 31, 42, 50, 62, 85, 101, 117, 134, 154, 175, 190, 206, 229, 239, 253 },
    { 20, 31, 39, 48, 62, 85, 101, 117, 131, 147, 163, 176, 188, 207, 216, 231 },
    { 10, 12, 15, 17, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75} },
  ////////////////////////////////////////
  //add new colors here
